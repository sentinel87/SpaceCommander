...
Technology TechTree[]={
  ...
  {7,"Radiolocation",0,0,100,150,0,"Unlock Radar building and increases visibility.","None",2,2},
...
Building Colony[]={
  ...
  {7,"Shipyard",0,1,"Required to build high level ships.",75,75,75,"None",0,0,8,1},
